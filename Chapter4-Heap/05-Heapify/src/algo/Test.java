...
public class Test{
    ...
    public static void main(String[] args){
        ...
        SortTestHelper.testSort("algo.HeapSort1", arr);
        ...
        SortTestHelper.testSort("algo.HeapSort1", arr5);
        SortTestHelper.testSort("algo.HeapSort2", arr6);
        SortTestHelper.testSort("algo.QuickSort3Ways", arr7);
        SortTestHelper.testSort("algo.MergeSort", arr8);
